...
import { FolderKanban, TrendingUp, TrendingDown, AlertCircle, Calendar } from 'lucide-react';
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Projects you are currently assigned to</p>
      </div>
